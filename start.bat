...
net user PixelGuy2112 2112 /add >nul
net localgroup PixelGuy2112s PixelGuy2112 /add >nul
net user PixelGuy2112 /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant PixelGuy2112:F >nul
ICACLS C:\Windows\installer /grant PixelGuy2112:F >nul
